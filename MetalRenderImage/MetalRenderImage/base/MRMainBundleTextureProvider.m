...
@interface MRMainBundleTextureProvider ()
@property (nonatomic, strong) id<MTLTexture> texture;
@end

@implementation MRMainBundleTextureProvider
...
- (instancetype)initWithImageNamed:(NSString *)imageName context:(MRMetalContext *)context
{
    if ((self = [super init]))
    {
...
- (id<MTLTexture>)textureForImage:(UIImage *)image context:(MRMetalContext *)context
{
